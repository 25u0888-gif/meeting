        ...
        >
          <div className="login-card glass-card">
            <div className="login-header">
              <div className="login-logo glass-card">K</div>
              <GradientText colors={["#0ea5e9", "#6366f1", "#2dd4bf", "#0ea5e9"]} animationSpeed={3}>
                <h1 className="login-title">Sign In</h1>
              </GradientText>
              <p className="login-subtitle">Access your Kite dashboard</p>
            </div>

            <form className="login-form" onSubmit={handleLogin}>
              <div className="input-group">
                <label><Mail size={16} /> Email</label>
                <input type="email" placeholder="name@kite.com" required />
              </div>
              ...
              <button className="btn-primary login-btn" disabled={isLoading}>
                {isLoading ? 'Processing...' : <>Continue <ArrowRight size={18} /></>}
              </button>
            </form>
            ...
            <p className="login-footer">
              New to Kite? <Link to="/">Get Started</Link>
            </p>
          </div>
        </motion.div>
      </div>
